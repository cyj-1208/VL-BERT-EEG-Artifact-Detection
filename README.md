...
## Data download
* Download the `TUAR` dataset including artifact and non-artifact samples from the [Temple University Hospital EEG Corpus (TUH EEG)](https://isip.piconepress.com/projects/nedc/html/tuh_eeg/).
